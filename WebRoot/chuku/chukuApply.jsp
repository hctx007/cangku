...
<body>
    <div style="margin-top:20px;margin-left:10px;">
		<span><h2>出库申请</h2></span>
	</div>

    <div  style="width: 100%; position: relative; left:25%;margin-top:30px;">
	<form:form  method="post" action="chukuApplyResult.do" class="layui-form" style="white-space:nowrap;">
		<div>
			
			<div style="margin-top:20px;">

                <div class="layui-form-item">
					<label class="layui-form-label"><h3>流水单号</h3></label>
					<div class="layui-input-inline">
						<input name="id"  class="layui-input" maxlength="18" required="required"/>
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input name="outTime"  id="demo1" autocomplete="off" class="layui-input" maxlength="15" required="required"/>
					</div>
					<div class="layui-form-mid layui-word-aux"></div>
				</div>
				...
				<div class="layui-form-item">
					<div class="layui-input-block" style="margin-left:13%;">
						<button class="layui-btn" lay-submit lay-filter="formDemo">审核出库申请</button>
					</div>
				</div>
