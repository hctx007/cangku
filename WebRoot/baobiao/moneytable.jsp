...
<html>
  ...
  <div style="" align='center'>
	...
	<select>					
    <input id="moneySearch" type="text"  value="请输入查询内容" onclick="JavaScript:this.value=''" style="height:25px;;margin-top:20px;"/>
  ...
  function search(){
		var moneySearch=document.getElementById("moneySearch").value;	
		var state=document.getElementById("state").value;	
		if(moneySearch=="请输入查询内容")
			moneySearch="";
	    window.location.href = "moneySearch.do?moneySearch="+moneySearch+"&state="+state;		  	
   }
