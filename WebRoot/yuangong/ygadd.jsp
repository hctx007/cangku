...
<body>
    ...
    <div style="margin-top:20px;margin-left:10px;">
		 <span><h2>添加员工</h2></span>
    </div>

    <div  style="width: 100%; position: relative; left:25%;margin-top:30px;">
	<form:form  method="post" action="ygAdd.do" class="layui-form" style="white-space:nowrap;">
		<div>
			...
			<div style="margin-top:20px;">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input name="ygName"  class="layui-input" maxlength="15" required="required"/>
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input name="ygAge"  class="layui-input" maxlength="15" required="required"/>
					</div>
					<div class="layui-form-mid layui-word-aux"></div>
				</div>
